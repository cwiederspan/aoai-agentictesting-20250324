...
public static class Program {
    ...
    public static async Task Main() {
        ...
        Console.WriteLine("ENV Value: " + configuration["AOAI_DEPLOYMENT"]);

        Console.WriteLine("Creating kernel...");
        IKernelBuilder builder = Kernel.CreateBuilder();

        builder.AddAzureOpenAIChatCompletion(
            configuration["AOAI_DEPLOYMENT"],
            configuration["AOAI_ENDPOINT"],
            configuration["AOAI_API_KEY"]
        );

        Kernel kernel = builder.Build();

        Kernel toolKernel = kernel.Clone();
        toolKernel.Plugins.AddFromType<MyPlugins>();
        ...
        ChatCompletionAgent agentReviewer =
            new() {
                ...
                Instructions =
                    ...
                    Once there is satisfactory content, make it uppercase using available tools and inform user.
    ...
    private sealed class MyPlugins {

        [KernelFunction]
        [Description("Converts any text to uppercase.")]
        public static string MakeUppercase(string content) {
